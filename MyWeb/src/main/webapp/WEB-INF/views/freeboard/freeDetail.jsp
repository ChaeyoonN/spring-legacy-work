        ...
        window.onload = function () {
            ...
            function getList(pageNum, reset) {
                ...
                .then(data => {
                    ...
                    if(reset){ //더보기 눌렀을 때 reset==false이므로 수행x
            ...
            */
            document.getElementById('replyList').addEventListener('click', e => { //addEventListener()의 매개변수: type, func 
            ...
            document.getElementById('modalDelBtn').onclick = () => {
                ...
                */
                ...
                if(replyPw ==='') {alert('비밀번호를 확인하세요!'); return;}
