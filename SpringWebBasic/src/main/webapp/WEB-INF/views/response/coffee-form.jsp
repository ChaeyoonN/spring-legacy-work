...
<body>
    ...
    <script>
    	...
    	//change: input이나 select 태그의 값이 변했을 때 ($ : html 요소 취득한 것임을 관례적으로 표시)
    	const $menu = document.getElementById('menu-sel');
    	$menu.onchange = e => { //프로퍼티방식(onchange) 이벤트, 매개변수 e는 이벤트 객체 받음
			//커피를 선택하면 가격이 변해야 함!
			console.log('이벤트 타겟: ', e.target.value); //이벤트객체.요소.값 : americano..
