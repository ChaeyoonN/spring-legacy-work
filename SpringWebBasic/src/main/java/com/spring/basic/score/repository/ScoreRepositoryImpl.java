...
@Repository // 빈 등록 -> Service가 의존하는 객체니까(서비스가 사용하는 객체니까)
public class ScoreRepositoryImpl implements IScoreRepository {
	...
	static {
		System.out.println("정적 초기화자 호출 언제되냐!");
	...
	public List<Score> findAll() {
		...
		//SCORE_MAP에서 value들만 전부 뽑아낸 뒤, ArrayList의 생성자 매개값으로 전달해서
		//List로 포장.
	...
	public void modify(Score modScore) {
		SCORE_MAP.put(modScore.getStuNum(), modScore); //map.put(기존키, 갈아끼울값);
