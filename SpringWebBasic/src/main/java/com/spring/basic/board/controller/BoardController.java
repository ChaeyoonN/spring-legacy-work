...
public class BoardController {
	...
	public void list(Model model) {
		...
		model.addAttribute("articles", service.getArticles()); //모델에 담아서 화면에 전달
	}
    ...
    public String modify(BoardModifyRequestDTO dto) {
    	System.out.println("/board/modify?boardNo= "+ dto.getBoardNo() +": POST");
    	service.modify(dto);
	...
	@GetMapping("/delete")
	public String delete(@RequestParam("boardNo") int boardNo) {//매개변수앞 아노테이션 리퀘스트파람 생략된거임
